...
namespace TwitterClient
{
    ...
    public class Twitter
    {
        ...
        public Twitter()
        {
            ...
            foreach (string str in TwitterClient.Properties.Settings.Default.DateTimeFormat) { strList.Add(str); }
            ...
            try {
                ...
                return new TwitData() {
                    ...
                    RTTwitData = (isRT) ? null
                        : new TwitData() {
                            TwitType = TwitterClient.TwitType.Normal,
                            DMScreenName = "",
        ...
        private TwitData ConvertToTwitDataDM(XElement el)
        {
            try {
                return new TwitData() {
                    TwitType = TwitterClient.TwitType.DirectMessage,
            ...
            try {
                ...
                foreach (var item in b) {
                    list.Add(new TwitData() {
                        TwitType = TwitterClient.TwitType.Search,
                        DMScreenName = "",
