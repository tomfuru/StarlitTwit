namespace TwitterClient
{
    partial class UctlDispTwitRow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.uctlline = new TwitterClient.UctlLine();
            this.rtxtGet = new TwitterClient.RichTextBoxHash();
            this.tooltipReply = new TwitterClient.PermanentToolTip(this.components);
            this.tooltipPicture = new TwitterClient.ToolTipPicture(this.components);
            ...
            this.rtxtGet.TweetItemClick += new System.EventHandler<TwitterClient.TweetItemClickEventArgs>(this.rtxtGet_TweetItemClick);
        ...
        private TwitterClient.RichTextBoxHash rtxtGet;
