...
{
    /// <summary>
    /// TwitterのAPI(Ver 1.1)処理を行うためのクラス。
    /// </summary>
    public class Twitter11_
    {
        //-------------------------------------------------------------------------------
        #region 定数
        //-------------------------------------------------------------------------------
        ...
        public const bool DEFAULT_INCLUDE_USER_ENTITIES = true;
        ...
        //-------------------------------------------------------------------------------
        #region +statuses_mentions_timeline
        //-------------------------------------------------------------------------------
        /// <summary>
        /// <para>statuses/mentions_timelineメソッド</para>
        /// <para>Returns the 20 most recent mentions (status containing @username) for the authenticating user.</para>
        /// <para>上限800</para>
        /// </summary>
        public IEnumerable<TwitData> statuses_mentions_timeline(int count = -1, long since_id = -1, long max_id = -1,
                                            ...
                                            bool contributor_details = false)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/mentions_timeline." + JSON, GET, paramdic);

            return ConvertToTwitDataArray(GetByAPIJson(url));
        }
        #endregion (statuses_mentions_timeline)
        //-------------------------------------------------------------------------------
                                           ...
                                           bool exclude_replies = false, bool contributor_details = false)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/user_timeline." + JSON, GET, paramdic);
                                                ...
                                                bool exclude_replies = false, bool contributor_details = false)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/home_timeline." + JSON, GET, paramdic);
        ...
        public IEnumerable<TwitData> statuses_retweets_of_me(int count = -1, long since_id = -1, long max_id = -1,
                                                  bool trim_user = false, bool include_entities = DEFAULT_INCLUDE_ENTITIES,
                                                  bool include_user_entities = DEFAULT_INCLUDE_USER_ENTITIES)
        {
            Dictionary<string, string> paramdic = new Dictionary<string, string>();
            {
                if (count > 0) { paramdic.Add("count", count.ToString()); }
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/retweets_of_me." + JSON, GET, paramdic);
        ...
        public IEnumerable<TwitData> statuses_retweets(long id, int count = -1, bool trim_user = false, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(string.Format("{0}statuses/retweets/{1}." + JSON, URLapi, id), GET, paramdic);
            return ConvertToTwitDataArray(GetByAPIJson(url));
        }
        ...
        public TwitData statuses_show(bool withAuthParam, long id, bool trim_user = false, bool include_my_retweet = true, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            Dictionary<string, string> paramdic = new Dictionary<string, string>();
            {
                if (trim_user) { paramdic.Add("trim_user", trim_user.ToString().ToLower()); }
            ...
            string url = GetUrlWithOAuthParameters(string.Format(@"{0}statuses/show/{1}." + JSON, URLapi, id), GET, paramdic);

            return ConvertToTwitData(GetByAPIJson(url));
        }
        ...
        public TwitData statuses_destroy(long id, bool trim_user = false, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/destroy/" + id.ToString() + "." + JSON, POST, paramdic);
            return ConvertToTwitData(PostToAPIJson(url));
        }
                                    ...
                                    string place_id = "", bool display_coordinates = false, bool trim_user = false, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/update." + JSON, POST, paramdic);
            return ConvertToTwitData(PostToAPIJson(url));
        }
        ...
        public TwitData statuses_retweet(long id, bool trim_user = false, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"statuses/retweet/" + id.ToString() + "." + JSON, POST, paramdic);
            return ConvertToTwitData(PostToAPIJson(url));
        }
                                            ...
                                            double latitude = double.NaN, double longtitude = double.NaN, string place_id = "", bool display_coordinates = false)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapiSSL + @"statuses/update_with_media." + JSON, POST, paramdic);

            XElement el = PostImageToAPIJson(url, "media[]", image_filename, image, contentType);
        ...
        public IEnumerable<TwitData> search_tweets(string q, string lang = "ja", string locale = "ja",
            int count = -1, long max_id = -1, long since_id = -1, string since = "",
            string until = "", object geocode = null, string result_type = "", bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapiSSL + "search/tweets." + JSON, GET, paramdic);

            XElement el = GetByAPIJson(url);

            //IEnumerable<TwitData> data = ConvertToTwitDataSearch(el);
            IEnumerable<TwitData> data = ConvertToTwitDataArray(el.Element("statuses"));
        ...
        /// </summary>
        public IEnumerable<TwitData> direct_messages(long since_id = -1, long max_id = -1, int count = -1,
                                                     bool include_entities = DEFAULT_INCLUDE_ENTITIES, bool skip_status = false)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapiSSL + @"direct_messages." + JSON, GET, paramdic);

            return ConvertToTwitDataArrayDM(GetByAPIJson(url));
        }
        ...
        public IEnumerable<TwitData> direct_messages_sent(long since_id = -1, long max_id = -1, int count = -1, int page = -1, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapiSSL + @"direct_messages/sent." + JSON, GET, paramdic);
        ...
        public TwitData direct_messages_destroy(long id, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapiSSL + @"direct_messages/destroy." + JSON, POST, paramdic);
            return ConvertToTwitDataDM(PostToAPIJson(url));
        }
        ...
        public TwitData direct_messages_new(string screen_name, long user_id, string text, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapiSSL + @"direct_messages/new." + JSON, POST, paramdic);

            XElement el = PostToAPIJson(url);
        ...
        {
            string url = GetUrlWithOAuthParameters(string.Format("{0}friendships/no_retweets/ids." + JSON, URLapi), GET);
            XElement el = GetByAPIJson(url);

            var enumid = el.Elements("item");
        ...
        public SequentData<long> followers_ids(long user_id = -1, string screen_name = null, long cursor = -1)
        {
            ...
            string urlbase = URLapi + @"followers/ids." + JSON;
            string url =  GetUrlWithOAuthParameters(urlbase, GET, paramdic);

            XElement el = GetByAPIJson(url);

            var ids = from id in el.Element("ids").Elements("item")
                      select long.Parse(id.Value);
        ...
        public SequentData<long> friends_ids(long user_id = -1, string screen_name = null, long cursor = -1)
        {
            if (user_id == -1 && string.IsNullOrEmpty(screen_name)) { throw new ArgumentException("ユーザーIDかスクリーン名の少なくとも1つは必要です。"); }
            Dictionary<string, string> paramdic = new Dictionary<string, string>();
            {
            ...
            string urlbase = URLapi + @"friends/ids." + JSON;
            string url = GetUrlWithOAuthParameters(urlbase, GET, paramdic);
        ...
        public IEnumerable<FriendshipData> friendships_lookup(long[] user_ids = null, string[] screen_names = null)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"friendships/lookup." + JSON, GET, paramdic);
            XElement el = GetByAPIJson(url);
        ...
        public SequentData<long> friendships_incoming(long cursor = -1)
        {
            ...
            string url = GetUrlWithOAuthParameters(string.Format("{0}friendships/incoming." + JSON, URLapi), GET, paramdic);
            XElement el = GetByAPIJson(url);
        ...
        public SequentData<long> friendships_outgoing(long cursor = -1)
        {
            ...
            string url = GetUrlWithOAuthParameters(string.Format("{0}friendships/outgoing." + JSON, URLapi), GET, paramdic);
            XElement el = GetByAPIJson(url);
        ...
        public UserProfile friendships_create(long user_id = -1, string screen_name = null, bool follow = true, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"friendships/create." + JSON, POST, paramdic);
            XElement el = PostToAPIJson(url);
        ...
        public UserProfile friendships_destroy(long user_id = -1, string screen_name = null, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"friendships/destroy." + JSON, POST, paramdic);
            XElement el = PostToAPIJson(url);
            return ConvertToUserProfile(el);
        }
                                       ...
                                       long target_id = -1, string target_screen_name = null)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"friendships/show." + JSON, GET, paramdic);
            XElement el = GetByAPIJson(url);
        ...
        public UserProfile users_show(long user_id = -1, string screen_name = null, bool include_entities = DEFAULT_INCLUDE_ENTITIES)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + @"users/show." + JSON, GET, paramdic);
            return ConvertToUserProfile(GetByAPIJson(url));
        }
        //-------------------------------------------------------------------------------
        ...
        public IEnumerable<TwitData> lists_statuses(long list_id = -1, string slug = "", string owner_screen_name = "", long owner_id = -1,
            long since_id = -1, long max_id = -1, int count = -1, bool include_entities = DEFAULT_INCLUDE_ENTITIES, bool include_rts = false)
        {
            ...
            string url = GetUrlWithOAuthParameters(URLapi + "lists/statuses." + JSON, GET, paramdic);
        ...
        {
            return from stat in el.Elements("item")
