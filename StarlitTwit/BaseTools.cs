...
namespace StarlitTwit
{
    ...
    //-------------------------------------------------------------------------------
    #region (Class)MyConvert データ変換関連
    //-------------------------------------------------------------------------------
    /// <summary>
    /// データ変換関連のメソッドを提供します．
    /// </summary>
    ...
    {
        //-------------------------------------------------------------------------------
        #region +EnumParse 指定文字列を列挙型に変換します
        //-------------------------------------------------------------------------------
        /// <summary>
        /// 指定文字列を列挙型に変換します
        /// </summary>
        /// <param name="item">列挙型に変換する文字列</param>
        /// <typeparam name="T">変換後の列挙型</typeparam>
        /// <returns>変換された列挙型</returns>
        public static T EnumParse<T>(string item)
        {
